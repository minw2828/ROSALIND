...
#        protein strings s1, s2,...,sn and a multiset R of 
#        positive numbers (corresponding to the complete 
#        spectrum of some unknown protein string).
#
# Return: The maximum multiplicity of R and S[Sk] taken over 
#         all strings Sk, followed by the string Sk for which 
#         this maximum multiplicity occurs you may output any 
